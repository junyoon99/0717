...
int main() 
{
	...
	//SaveToXML("D:\\GameCanvas\\9\\0717\\0717\\monsters.xml", monsters);

	//monsters.clear();
	//LoadFromXML("D:\\GameCanvas\\9\\0717\\0717\\monsters.xml", monsters);

	//m.GetDropItems().clear();

	SaveToJSON("D:\\GameCanvas\\9\\0717\\0717\\monsters.json", monsters);
	monsters.clear();

	LoadFromJSON("D:\\GameCanvas\\9\\0717\\0717\\monsters.json", monsters);
}